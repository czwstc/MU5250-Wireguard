...
export const api = {
  ...
  wireguard: () => get('/api/wireguard').then(d => d as unknown as WireGuardStatus),
  wireguardSet: (body: WireGuardUpdate) => req('PUT', '/api/wireguard', body, undefined, 120_000).then(d => d as unknown as WireGuardStatus),
